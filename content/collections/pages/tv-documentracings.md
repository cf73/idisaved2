...
main_content:
  -
    ...
    type: text
    enabled: true
thumbnail_image: tvdocutrs.001.jpeg
thumbnail_caption: 'TV Documentracings are drawings using the documentracing method by extracting parts from a live television screen. Each drawing experimented with different sets of systems or rules for the selection to extract.'
---
